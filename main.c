...
void main(void)
{
    ...
    //Logic
    void action(int moisture, int temperature, int light, int mode);
    ...
    while(1) //Do this when you want an infinite loop of code
    {
        ...
        */
        ...
        temperature=TEMP_1();
        light=LIGHT();
        //action(moisture, temperature, light, mode);
        ...
        */
        ...
        //GPIO_getInputPinValue(SW1_PORT, SW1_PIN);
        /*
        if (GPIO_getInputPinValue(SW1_PORT, SW1_PIN)){
            PB_Not_Pressed();
        }else{
        ...
        */
        ...
        //Used to change display information
        counter++;
        if(counter==3000){
            //printf("Temp %d", temperature);
            //displayText("T");
            displayText("T ");
            showHex((int)temperature);
        }else if(counter==6000){
            //char *moist[4]=moisture;
            displayText("M ");
            showHex((int)moisture);
...
//LCD DISPLAY
//void LCD_DISPLAY(int moisture, int temperature, int mode){
 //   displayScrollText("Moisture Content: %d, Temperature: %d, Mode: %d", );
//}
    ...
    if(mode=1){
        ...
        */
        ...
        //Daylight
            ...
            //Irrigation System is off
            BLUE_LED(0);

            //Temperature above maximum
            if(temperature>MAX_TEMP){

                //Ventilation in zone 1 on
                MOTOR_1(1);
                GREEN_LED(1);
            }
